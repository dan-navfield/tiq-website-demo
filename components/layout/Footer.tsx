...
const footerColumns = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Investment prospectus", href: "/invest/investment-prospectus" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Grants", href: "/export/grants" },
      { label: "Export Ready", href: "/export/export-and-expand" },
      { label: "Exporter success stories", href: "/export/export-success-stories" },
    ],
  },
  {
    title: "",
...
const socialLinks = [
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/tradeinvestqld/",
    icon: (
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/TradeandInvestmentQld",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/tradeinvestqld/",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    label: "YouTube",
    href: "https://www.youtube.com/channel/UCGvzXsQY7gWF7Ym_siiQ3bA",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
...
const legalLinks = [
  ...
  { label: "Publications and data", href: "/about/strategies-publications-policies" },
  { label: "Right to information", href: "/contact/accessing-information/right-to-information" },
  { label: "Website feedback", href: "/contact/our-offices" },
];
